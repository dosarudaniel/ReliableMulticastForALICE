...
public class HTMLFormatter implements SQLFormatter {
	...
	writer.write(
		"<br><br><table style='font-size:10px' border=1 cellspacing=0 cellpadding=2><thead><tr><th>Subfolder</th>");

	if (extendedReport)
	    writer.write(
		    "<th>Own objects</th><th>Own size</th><th>Subfolder objects</th><th>Subfolder total size</th>");
