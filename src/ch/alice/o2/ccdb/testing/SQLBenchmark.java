...
public class SQLBenchmark {
	...
	for (final int queryThreads : new int[] { 1, 4, 8, 16, 24, 32 }) {
	    ...
	    System.err.println(queryThreads + " threads: " + (noQueries * queryThreads) + " queried in "
		    + Format.toInterval(System.currentTimeMillis() - startQueryTime) + ", equivalent to "
		    + (double) (System.currentTimeMillis() - startQueryTime) / (noQueries * queryThreads)
		    + " ms/object and " + (double) (System.currentTimeMillis() - startQueryTime) / noQueries
		    + " ms/object/thread");
